...
In web3 today the terms "Insufficient Balance," "Not Enough ETH," "Balance: 0" and other synonyms are ubiquitous. Checkout seeks to end this status quo.

In web3, there's a common design pattern where actions constitute a source asset and a target asset or action. Here's how it works:
