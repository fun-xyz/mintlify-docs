...
Optimized for maximum access to liquidity.
...
- **Multi-Chain Fund Access:** Users can pull funds from any token on any EVM chain. This broad compatibility ensures that no matter where the user's assets are held, they can be easily accessed and utilized.

- **Platform Integration:** When integrated into platforms that manage their own liquidity, Checkout can leverage this liquidity effectively. This symbiotic relationship boosts both Checkout's functionality and the partner platform's user experience.
...
## Compliance
At Fun.xyz, compliance is a cornerstone of our operations. We have meticulously designed our routing engine to function as an entirely non-custodial protocol, maintained and operated by decentralized actors. Here’s how we ensure compliance:
